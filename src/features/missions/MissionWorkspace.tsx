...
import { RunModelAssignmentsPanel } from "./RunModelAssignmentsPanel";
...
function MissionSummary({
  ...
  return <div className="os-mission-summary">
    ...
    {run && <>
      ...
      <RunModelAssignmentsPanel runId={run.id} />
